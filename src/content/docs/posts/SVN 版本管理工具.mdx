...
date: 2018-11-11
category: "软件工具"
image: "/images/site/bg2.jpg"
tags: ["Tutorial", "SVN"]
---

{/* 文章维护说明：SVN 工具教程，命令示例保留为集中式版本管理参考。 */}
...
mkdir hello
# 初始化
# svnadmin create 会在 hello 目录中创建一个仓库，而不是工作副本。
...
# 原文命令中的 chekcout 应为 checkout；这里保留原命令作为历史记录。
...
svn status
# 添加文件夹
# svn add 只是加入版本控制，真正写入仓库需要 svn commit。
svn add *
# 再次查看当前状态
svn status
# 提交
...
# 解决冲突
# update 会拉取远端改动并在本地标记冲突文件，随后需要手工选择保留哪一边。
svn update
# ...
